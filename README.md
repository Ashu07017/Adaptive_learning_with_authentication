# SkillEdge – Interactive Quiz Application

## Overview
**SkillEdge** is a full-stack, role-based quiz application built using the **MERN Stack (MongoDB, Express.js, React.js, Node.js)**.  
...
git clone https://github.com/<your-username>/SkillEdge.git
